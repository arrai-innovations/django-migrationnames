...
INSTALLED_APPS = [
    ...
    "project.app_two.apps.AppTwoConfig",
    "project.app_three.apps.AppThreeConfig",
    "project.app_four.apps.AppSevenConfig",
    "project.app_five.apps.AppFiveConfig",
    "project.app_six.apps.AppSixConfig",
    "project.app_seven.apps.AppSevenConfig",
    "project.app_eight.apps.AppEightConfig",
    "project.app_nine.apps.AppNineConfig",
    "project.app_ten.apps.AppTenConfig",
    ...
    "project.app_fourteen.apps.AppFourteenConfig",
